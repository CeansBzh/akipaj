<section>
    <form method="post" action="{{ route('payments.store') }}">
        ...
        <div x-data="app()" x-cloak>
            <div class="mx-auto flex max-w-xl items-center justify-center px-4 py-2">

                {{-- Error modal --}}
                <x-modal name="photo-create-errors" :show="$errors->isNotEmpty()">
                    <div class="flex p-10 text-center">
                        <div class="mx-auto">
                            ...
                            <h2 class="mb-4 text-2xl font-bold text-gray-800">Erreurs lors de
                                l'envoi</h2>

                            <ul class="mb-5 list-decimal text-sm text-gray-600">
                ...
                <div class="w-full md:min-w-[30vw]">
                    ...
                    <div class="flex border-b-2 py-2">
                        <div class="my-auto mr-2 text-xs font-bold uppercase leading-tight tracking-wide text-sky-500"
                            x-text="`Étape ${step}`"></div>
                        <div x-show="step === 1">
                            <div class="text-lg font-bold leading-tight text-gray-700">Choisir le montant</div>
                        </div>
                        <div x-show="step === 2">
                            <div class="text-lg font-bold leading-tight text-gray-700">Informations de paiement
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="flex flex-row text-gray-700">
                                        <div class="w-fit">
                                            <input id="amount" type="text" name="amount" x-model="amount"
                                                @input="updateAmount"
                                                class="mx-auto w-[3.5ch] min-w-[3.5ch] border-0 border-b-4 border-gray-400 p-0 text-5xl placeholder:text-gray-400 focus:border-sky-500 focus:ring-0"
                                                placeholder="0,00">
                                        </div>
                                        <p class="select-none self-center text-5xl">€</p>
                                    </div>
                            ...
                            <div id="card_form" class="flex flex-col space-y-4">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <x-text-input id="card_cvc" dir="ltr" type="text"
                                            inputmode="numeric" name="card_cvc" maxlength="4"
                                            class="mt-1 block w-full" placeholder="CVC" autocomplete="billing cc-csc"
                                            aria-invalid="false" zzRequired />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="card_holder_name" dir="ltr" type="text"
                                        name="card_holder_name" maxlength="128" class="mt-1 block w-full"
                                        placeholder="Prénom Nom" autocomplete="billing cc-name" aria-invalid="false"
                                        zzRequired />
            ...
            <div class="fixed bottom-0 left-0 right-0">
                <div class="mx-auto h-20 max-w-3xl rounded-t-xl bg-white p-5 drop-shadow-[0_-6px_6px_rgba(0,0,0,0.1)]">
                    <div class="flex justify-between">
                        <div class="mr-2">
                            <x-secondary-button x-show="step == 1" @click="history.back()">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 sm:hidden"
        ...
        function app() {
            return {
                ...
                updateAmount: function() {
                    ...
                    this.amount = this.amount.match(/([1-9]\d{0,2}(?:,\d{0,2})?)|(?:(?![1-9]\d{0,2}(?:,\d{0,2})?).)*/)[
                        1] || '';
