...
<section class="mx-auto max-w-3xl">
    <ul class="flex flex-col space-y-6 max-w-full">
        @forelse ($events as $event)
            <li id="event-item-{{ $event->id }}" class="event-item shadow-lg relative cursor-pointer">
                ...
                <div
                    ...
                    <div
                        ...
                        <x-primary-button type="button" class="add-to-agenda event-item-clickable max-w-min md:hidden"
                    ...
                    <div class="self-center hidden max-w-min md:block lg:max-w-fit">
                        <x-primary-button type="button" class="add-to-agenda event-item-clickable">
                            + Ajouter à l'agenda
                        </x-primary-button>
                    </div>
                </div>
