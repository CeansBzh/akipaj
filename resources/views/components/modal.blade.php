@props(['name', 'show' => false, 'maxWidth' => '2xl', 'transparent' => false])
...
<div x-data="{
    ...
    <div x-show="show"
        class="{{ $transparent ? '' : 'bg-white shadow-xl' }} {{ $maxWidth }} mb-6 transform overflow-hidden rounded-lg transition-all sm:mx-auto sm:w-full"
