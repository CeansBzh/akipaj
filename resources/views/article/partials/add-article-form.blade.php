<section class="max-w-2xl mx-auto" x-data="addArticle()">
    <header>
    ...
    <form id="add-article-form" method="post" action="{{ route('articles.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex space-x-2 items-center">
                ...
                <input id="online_input" type="checkbox" name="online" class="rounded" {{ old('online') ? 'checked' : '' }}>
