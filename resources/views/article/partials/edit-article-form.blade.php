<section class="max-w-2xl mx-auto" x-data="editArticle()" x-init="init()">
    <header>
    ...
    <form id="add-article-form" method="post" action="{{ route('articles.update', $article) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('patch')
