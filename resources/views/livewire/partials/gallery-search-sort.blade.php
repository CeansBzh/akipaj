    ...
    <div class="flex flex-wrap justify-center p-1 md:justify-end">
        <div class="relative w-96 mb-2">
            ...
            <x-text-input type="text" placeholder="Rechercher par titre ou légende" wire:model="searchTerm"
                class="px-8 py-3 w-full text-sm text-gray-500 xs:rounded-r-none xs:rounded-l-md" />
        </div>
        <x-secondary-button class="mb-2 focus:ring-offset-0 xs:rounded-r-md xs:rounded-l-none"
            ::class="{'ring-2': open}" @click="open = ! open">
