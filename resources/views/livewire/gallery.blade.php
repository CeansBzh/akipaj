<div x-data="gallery()" class="px-2">
    ...
    <div id="gallery-grid" class="grid grid-cols-1 gap-0.5 auto-rows-[20px] xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
        wire:ignore.self>
        ...
        @if ($hasMorePages)
            <div x-intersect.margin.200px="loadMorePhotos" class="col-span-4"></div>
        @endif
    </div>
    @push('scripts')
